...
现有项目材料能够支撑可追溯的系统设计、交互式移动原型和已汇报的形成性观察，且源码仓库与精确的实现快照已经检查；然而，E1--E3 实验输出以及 E4 的参与者级记录尚未提供，因此有效性结果仍明确标记为待验证。
...
The supplied project materials establish a traceable system design, an interactive mobile prototype, and reported formative observations, and the source repository and exact implementation snapshots have now been inspected; however, E1--E3 experimental outputs and participant-level E4 records remain unavailable, so effectiveness results remain explicitly pending.
