...
\sjtusetup{
  ...
  info = {%
    ...
    % 关键词
    %
    zh / keywords        = {科研文献管理，检索增强生成，修订感知检索，证据可追溯性，可解释推荐，移动研究助手},
    en / keywords        = {scholarly literature management, retrieval-augmented generation, revision-aware retrieval, evidence traceability, explainable recommendation, mobile research assistant},
    %
    % 姓名
    %
    ...
    % 所属院系
    %
    zh / department      = {浦江国际学院},
    en / department      = {SJTU Global College},
    %
    % 答辩日期
