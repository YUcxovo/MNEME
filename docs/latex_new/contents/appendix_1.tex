...
This appendix records the normative criteria that guided the system design. It does not report test outcomes. Chapter~4 identifies the criteria exercised in the integrated mobile workflow and records their expected and actual results in Table~\ref{tab:feature-acceptance}; a criterion absent from that table must not be read as having passed.
...
\begin{itemize}
  ...
  \item Given an eligible weekly briefing, the client publishes at most one notification for its digest identity, and opening the notification restores that exact briefing.
\end{itemize}
