...
本文贡献了一套连接论文版本、来源证据、行为记忆和移动状态的系统方法，并提供可复现实验证据。评价限于所报告的问答案例、受控轨迹和单一 Android 模拟器环境，词汇来源检查衡量局部文本支持。在此范围内，MNEME 验证了重复安全的事件上传和可检查的移动工作流。
\end{abstract}
