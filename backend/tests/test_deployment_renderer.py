...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"server_name": "api.example.com", "install_dir": Path("/opt")},
        ...
        {"server_name": "api.example.com", "environment_file": Path("/etc")},
        {"server_name": "api.example.com", "environment_file": Path("/etc/mneme/backend")},
        {"server_name": "api.example.com", "paper_data_dir": Path("/tmp/papers")},
        {"server_name": "api.example.com", "paper_data_dir": Path("/var/lib")},
        {"server_name": "api.example.com", "backup_dir": Path("/tmp/backups")},
        {"server_name": "api.example.com", "backup_dir": Path("/var/backups")},
